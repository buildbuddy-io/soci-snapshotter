...
func (kc *keychain) getCredentials(refspec reference.Spec) (string, string, error) {
...
func Keychain(ctx context.Context) resolver.Credential {
	...
	return func(refspec reference.Spec, _ /** host **/ string) (string, string, error) {
		return singleton.getCredentials(refspec)
	}
}
